...
const Footer = () => {
  ...
  const media =
    "text-white hover:text-green h-[25px] xs:h-[35px] w-[25px] xs:w-[35px]";
      ...
      <div className="wrapper px-[30px] xs:px-[60px] pt-[30px] xs:pt-[60px] space-y-[20px]">
        ...
        <div className="flex flex-col sm:flex-row space-y-[30px] xs:space-y-[50px] sm:space-y-0 sm:space-x-[10%]">
          ...
          <div className={`${columns}`}>
            ...
            <a className={`${text} hover:text-green`} href="#odbiory">
              Odbiory
            </a>
            <a className={`${text} hover:text-green`} href="#oferta">
              Oferta
            </a>
            <a className={`${text} hover:text-green`} href="#kontakt">
              Kontakt
            </a>
          </div>
          <div className={`${columns}`}>
            ...
            <a className={`${text} hover:text-green`} href="/regulamin">
              Regulamin
            </a>
          </div>
        </div>
