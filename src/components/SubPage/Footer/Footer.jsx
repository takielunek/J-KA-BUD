  ...
  return (
    <div id="kontakt" className="bg-navy">
      <div className="wrapper px-[30px] xs:px-[60px] pt-[30px] xs:pt-[60px] space-y-[20px]">
        ...
        <div className="flex flex-col lg:flex-row space-y-[50px] lg:space-y-0 lg:space-x-[6%] xl:space-x-[10%]">
          ...
          <div className={`${columns}`}>
            ...
            <a className={`${text} hover:text-green`} href="/odbior-techniczny">
              Odbiór techniczny nieruchomości
            </a>
            <a className={`${text} hover:text-green`} href="/protokol">
